# Local Bulk Asset License Evidence

Status: License evidence provided
Related bundles: `BND-010`, `BND-011`
Recorded date: 2026-05-26
Evidence source: User-provided license text in `C:\Users\dferr\dev\license.txt`

## Applies To

This evidence applies to local bulk asset promotions whose bundle manifests reference this file, including present repo raw payloads and sibling-folder asset payloads promoted through the governed asset pipeline.
