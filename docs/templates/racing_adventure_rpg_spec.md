# Racing Adventure RPG Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `racing_adventure_rpg`

## Purpose

The `racing_adventure_rpg` template covers vehicle_stats, track_events, overworld_racing, licenses starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: vehicle_upgrade_loop, track_event_loop, license_progression_loop, save_loop. |
...
Racing Adventure RPG starter projects with vehicle_stats, track_events, overworld_racing, licenses, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
