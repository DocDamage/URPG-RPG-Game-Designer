...
Authority: canonical template spec for `shmup`

## Purpose

The `shmup` template covers bounded Shmup starter projects with waves, bullets, powerups, bosses, generated starter data, runtime profile evidence, diagnostics, and export validation.

## Required Subsystems

| Subsystem | Rationale |
| --- | --- |
| `ui_menu_core` | Required for bounded Shmup starter project generation, preview, save, and export evidence. |
| `message_text_core` | Required for bounded Shmup starter project generation, preview, save, and export evidence. |
| `save_data_core` | Required for bounded Shmup starter project generation, preview, save, and export evidence. |
| `presentation_runtime` | Required for bounded Shmup starter project generation, preview, save, and export evidence. |
| `export_validator` | Required for bounded Shmup starter project generation, preview, save, and export evidence. |
...
Shmup starter projects with waves, bullets, powerups, bosses, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
