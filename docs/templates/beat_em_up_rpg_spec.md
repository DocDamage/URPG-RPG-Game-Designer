...
The `beat_em_up_rpg` template covers brawler_combat, combos, pickups, stage_progression starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: stage_brawler_loop, combo_progression_loop, pickup_reward_loop, save_loop. |
...
Beat Em Up RPG starter projects with brawler_combat, combos, pickups, stage_progression, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
