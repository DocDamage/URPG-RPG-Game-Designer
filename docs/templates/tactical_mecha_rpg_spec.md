...
The `tactical_mecha_rpg` template covers parts_loadout, heat_ammo, pilot_bonds, grid_deployment starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: mech_loadout_loop, grid_battle_loop, pilot_bond_loop, save_loop. |
...
Tactical Mecha RPG starter projects with parts_loadout, heat_ammo, pilot_bonds, grid_deployment, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
