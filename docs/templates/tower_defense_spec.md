# Tower Defense Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `tower_defense`

## Purpose

The `tower_defense` template covers bounded Tower Defense starter projects with waves, towers, lanes, upgrades, generated starter data, runtime profile evidence, diagnostics, and export validation.

## Required Subsystems

| Subsystem | Rationale |
| --- | --- |
| `ui_menu_core` | Required for bounded Tower Defense starter project generation, preview, save, and export evidence. |
| `message_text_core` | Required for bounded Tower Defense starter project generation, preview, save, and export evidence. |
| `save_data_core` | Required for bounded Tower Defense starter project generation, preview, save, and export evidence. |
| `presentation_runtime` | Required for bounded Tower Defense starter project generation, preview, save, and export evidence. |
| `export_validator` | Required for bounded Tower Defense starter project generation, preview, save, and export evidence. |
...
Tower Defense starter projects with waves, towers, lanes, upgrades, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
