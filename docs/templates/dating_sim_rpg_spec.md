# Dating Sim RPG Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `dating_sim_rpg`

## Purpose

The `dating_sim_rpg` template covers bounded Dating Sim RPG starter projects with affection, schedules, date_events, endings, generated starter data, runtime profile evidence, diagnostics, and export validation.

## Required Subsystems

| Subsystem | Rationale |
| --- | --- |
| `ui_menu_core` | Required for bounded Dating Sim RPG starter project generation, preview, save, and export evidence. |
| `message_text_core` | Required for bounded Dating Sim RPG starter project generation, preview, save, and export evidence. |
| `battle_core` | Required for bounded Dating Sim RPG starter project generation, preview, save, and export evidence. |
| `save_data_core` | Required for bounded Dating Sim RPG starter project generation, preview, save, and export evidence. |
| `export_validator` | Required for bounded Dating Sim RPG starter project generation, preview, save, and export evidence. |
...
Dating Sim RPG starter projects with affection, schedules, date_events, endings, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
