# Idle Incremental RPG Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `idle_incremental_rpg`

## Purpose

The `idle_incremental_rpg` template covers offline_gains, prestige, auto_battle, upgrade_tree starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: offline_gain_loop, auto_battle_loop, prestige_upgrade_loop, save_loop. |
...
Idle Incremental RPG starter projects with offline_gains, prestige, auto_battle, upgrade_tree, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
