# Sports Team RPG Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `sports_team_rpg`

## Purpose

The `sports_team_rpg` template covers team_roster, training, season_matches, relationships starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: team_roster_loop, training_week_loop, match_day_loop, save_loop. |
...
Sports Team RPG starter projects with team_roster, training, season_matches, relationships, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
