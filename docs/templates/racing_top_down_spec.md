# Top Down Racing Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `racing_top_down`

## Purpose

The `racing_top_down` template covers bounded Top Down Racing starter projects with tracks, laps, checkpoints, handling, generated starter data, runtime profile evidence, diagnostics, and export validation.

## Required Subsystems

| Subsystem | Rationale |
| --- | --- |
| `ui_menu_core` | Required for bounded Top Down Racing starter project generation, preview, save, and export evidence. |
| `message_text_core` | Required for bounded Top Down Racing starter project generation, preview, save, and export evidence. |
| `save_data_core` | Required for bounded Top Down Racing starter project generation, preview, save, and export evidence. |
| `presentation_runtime` | Required for bounded Top Down Racing starter project generation, preview, save, and export evidence. |
| `export_validator` | Required for bounded Top Down Racing starter project generation, preview, save, and export evidence. |
...
Top Down Racing starter projects with tracks, laps, checkpoints, handling, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
