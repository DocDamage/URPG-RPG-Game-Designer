...
The `school_life_rpg` template covers classes, clubs, social_links, exams starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: class_calendar_loop, club_activity_loop, social_link_loop, save_loop. |
...
School Life RPG starter projects with classes, clubs, social_links, exams, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
