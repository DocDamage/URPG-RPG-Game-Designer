# Beat Em Up Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `beat_em_up`

## Purpose

The `beat_em_up` template covers bounded Beat Em Up starter projects with lanes, waves, combos, pickups, generated starter data, runtime profile evidence, diagnostics, and export validation.

## Required Subsystems

| Subsystem | Rationale |
| --- | --- |
| `ui_menu_core` | Required for bounded Beat Em Up starter project generation, preview, save, and export evidence. |
| `message_text_core` | Required for bounded Beat Em Up starter project generation, preview, save, and export evidence. |
| `save_data_core` | Required for bounded Beat Em Up starter project generation, preview, save, and export evidence. |
| `presentation_runtime` | Required for bounded Beat Em Up starter project generation, preview, save, and export evidence. |
| `export_validator` | Required for bounded Beat Em Up starter project generation, preview, save, and export evidence. |
...
Beat Em Up starter projects with lanes, waves, combos, pickups, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
