...
The `soulslike_lite_rpg` template covers stamina_combat, currency_recovery, boss_phases, checkpoint_respawn starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: stamina_combat_loop, checkpoint_recovery_loop, boss_phase_loop, save_loop. |
...
Soulslike Lite RPG starter projects with stamina_combat, currency_recovery, boss_phases, checkpoint_respawn, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
