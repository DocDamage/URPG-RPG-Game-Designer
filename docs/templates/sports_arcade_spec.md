# Sports Arcade Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `sports_arcade`

## Purpose

The `sports_arcade` template covers bounded Sports Arcade starter projects with matches, stats, simple_ai, teams, generated starter data, runtime profile evidence, diagnostics, and export validation.

## Required Subsystems

| Subsystem | Rationale |
| --- | --- |
| `ui_menu_core` | Required for bounded Sports Arcade starter project generation, preview, save, and export evidence. |
| `message_text_core` | Required for bounded Sports Arcade starter project generation, preview, save, and export evidence. |
| `save_data_core` | Required for bounded Sports Arcade starter project generation, preview, save, and export evidence. |
| `presentation_runtime` | Required for bounded Sports Arcade starter project generation, preview, save, and export evidence. |
| `export_validator` | Required for bounded Sports Arcade starter project generation, preview, save, and export evidence. |
...
Sports Arcade starter projects with matches, stats, simple_ai, teams, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
