# Faction Politics RPG Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `faction_politics_rpg`

## Purpose

The `faction_politics_rpg` template covers reputation, diplomacy, faction_quests, territory_influence starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: reputation_choice_loop, diplomacy_mission_loop, territory_influence_loop, save_loop. |
...
Faction Politics RPG starter projects with reputation, diplomacy, faction_quests, territory_influence, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
