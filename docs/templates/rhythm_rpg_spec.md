# Rhythm RPG Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `rhythm_rpg`

## Purpose

The `rhythm_rpg` template covers beat_timed_combat, song_charts, timing_windows, grades starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: song_chart_loop, timed_battle_loop, performance_grade_loop, save_loop. |
...
Rhythm RPG starter projects with beat_timed_combat, song_charts, timing_windows, grades, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
