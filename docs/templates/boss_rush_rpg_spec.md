# Boss Rush RPG Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `boss_rush_rpg`

## Purpose

The `boss_rush_rpg` template covers bounded Boss Rush RPG starter projects with boss_phases, builds, upgrades, unlocks, generated starter data, runtime profile evidence, diagnostics, and export validation.

## Required Subsystems

| Subsystem | Rationale |
| --- | --- |
| `ui_menu_core` | Required for bounded Boss Rush RPG starter project generation, preview, save, and export evidence. |
| `message_text_core` | Required for bounded Boss Rush RPG starter project generation, preview, save, and export evidence. |
| `battle_core` | Required for bounded Boss Rush RPG starter project generation, preview, save, and export evidence. |
| `save_data_core` | Required for bounded Boss Rush RPG starter project generation, preview, save, and export evidence. |
| `export_validator` | Required for bounded Boss Rush RPG starter project generation, preview, save, and export evidence. |
...
Boss Rush RPG starter projects with boss_phases, builds, upgrades, unlocks, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
