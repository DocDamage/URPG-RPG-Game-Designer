# Educational Quiz Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `educational_quiz`

## Purpose

The `educational_quiz` template covers bounded Educational Quiz starter projects with questions, categories, scoring, feedback, generated starter data, runtime profile evidence, diagnostics, and export validation.

## Required Subsystems

| Subsystem | Rationale |
| --- | --- |
| `ui_menu_core` | Required for bounded Educational Quiz starter project generation, preview, save, and export evidence. |
| `message_text_core` | Required for bounded Educational Quiz starter project generation, preview, save, and export evidence. |
| `save_data_core` | Required for bounded Educational Quiz starter project generation, preview, save, and export evidence. |
| `presentation_runtime` | Required for bounded Educational Quiz starter project generation, preview, save, and export evidence. |
| `export_validator` | Required for bounded Educational Quiz starter project generation, preview, save, and export evidence. |
...
Educational Quiz starter projects with questions, categories, scoring, feedback, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
