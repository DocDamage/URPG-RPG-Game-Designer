# MMORPG Lite Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `mmorpg_lite`

## Purpose

The `mmorpg_lite` template covers bounded MMORPG Lite starter projects with zones, quests, role_abilities, vendors, generated starter data, runtime profile evidence, diagnostics, and export validation.

## Required Subsystems

| Subsystem | Rationale |
| --- | --- |
| `ui_menu_core` | Required for bounded MMORPG Lite starter project generation, preview, save, and export evidence. |
| `message_text_core` | Required for bounded MMORPG Lite starter project generation, preview, save, and export evidence. |
| `battle_core` | Required for bounded MMORPG Lite starter project generation, preview, save, and export evidence. |
| `save_data_core` | Required for bounded MMORPG Lite starter project generation, preview, save, and export evidence. |
| `export_validator` | Required for bounded MMORPG Lite starter project generation, preview, save, and export evidence. |
...
MMORPG Lite starter projects with zones, quests, role_abilities, vendors, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
