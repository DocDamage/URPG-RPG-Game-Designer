# Brick Breaker Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `brick_breaker`

## Purpose

The `brick_breaker` template covers bounded Brick Breaker starter projects with paddle, ball_physics, bricks, powerups, generated starter data, runtime profile evidence, diagnostics, and export validation.

## Required Subsystems

| Subsystem | Rationale |
| --- | --- |
| `ui_menu_core` | Required for bounded Brick Breaker starter project generation, preview, save, and export evidence. |
| `message_text_core` | Required for bounded Brick Breaker starter project generation, preview, save, and export evidence. |
| `save_data_core` | Required for bounded Brick Breaker starter project generation, preview, save, and export evidence. |
| `presentation_runtime` | Required for bounded Brick Breaker starter project generation, preview, save, and export evidence. |
| `export_validator` | Required for bounded Brick Breaker starter project generation, preview, save, and export evidence. |
...
Brick Breaker starter projects with paddle, ball_physics, bricks, powerups, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
