# Space Opera RPG Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `space_opera_rpg`

## Purpose

The `space_opera_rpg` template covers crew_roster, ship_travel, planet_landings, faction_reputation starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: crew_management_loop, starship_travel_loop, faction_mission_loop, save_loop. |
...
Space Opera RPG starter projects with crew_roster, ship_travel, planet_landings, faction_reputation, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
