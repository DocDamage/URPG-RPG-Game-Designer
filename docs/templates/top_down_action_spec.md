# Top Down Action Template Spec

Status Date: 2026-05-01
Authority: canonical template spec for `top_down_action`

## Purpose

The `top_down_action` template covers bounded Top Down Action starter projects with movement, attacks, enemies, pickups, generated starter data, runtime profile evidence, diagnostics, and export validation.

## Required Subsystems

| Subsystem | Rationale |
| --- | --- |
| `ui_menu_core` | Required for bounded Top Down Action starter project generation, preview, save, and export evidence. |
| `message_text_core` | Required for bounded Top Down Action starter project generation, preview, save, and export evidence. |
| `save_data_core` | Required for bounded Top Down Action starter project generation, preview, save, and export evidence. |
| `presentation_runtime` | Required for bounded Top Down Action starter project generation, preview, save, and export evidence. |
| `export_validator` | Required for bounded Top Down Action starter project generation, preview, save, and export evidence. |
...
Top Down Action starter projects with movement, attacks, enemies, pickups, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
