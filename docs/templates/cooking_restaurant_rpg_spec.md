...
The `cooking_restaurant_rpg` template covers recipes, customer_queue, restaurant_upgrades, food_buffs starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: recipe_prep_loop, customer_queue_loop, restaurant_upgrade_loop, save_loop. |
...
Cooking Restaurant RPG starter projects with recipes, customer_queue, restaurant_upgrades, food_buffs, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
