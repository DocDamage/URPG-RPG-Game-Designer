...
The `city_builder_rpg` template covers town_placement, citizen_needs, resident_quests, resource_chains starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: district_build_loop, citizen_need_loop, resource_chain_loop, save_loop. |
...
City Builder RPG starter projects with town_placement, citizen_needs, resident_quests, resource_chains, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
