...
The `open_world_survival_rpg` template covers hunger_thirst, camps, crafting, dynamic_events starter projects with authored data, WYSIWYG preview surfaces, saved project state, runtime execution, diagnostics, and export validation.
...
| Input | `READY` | Starter projects expose the required loops: camp_setup_loop, survival_needs_loop, biome_event_loop, save_loop. |
...
Open World Survival RPG starter projects with hunger_thirst, camps, crafting, dynamic_events, WYSIWYG showcase coverage, saved project data, runtime hooks, diagnostics, and export validation.
