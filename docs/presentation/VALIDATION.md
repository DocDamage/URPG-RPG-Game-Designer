...
- **Standalone executable**:
  - `build-local\Debug\urpg_presentation_release_validation.exe`
- **What it covers**:
...
- `build-local\Debug\urpg_tests.exe "[presentation]"`
- `build-local\Debug\urpg_tests.exe "[editor][spatial]"`
