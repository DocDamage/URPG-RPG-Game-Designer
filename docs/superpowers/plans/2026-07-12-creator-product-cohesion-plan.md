...
| M9 | Draft seeded | The governed vertical-slice scenario has a native-wizard two-map draft seed, a contextual native export-preflight route, and a strict report gate, but no creator-authored passed runtime/package report exists. |
