...
| M8 | Initial implementation | Map can open the active project’s durable Character Creator draft while preserving project/Map context and shared save, navigation, and recovery ownership. Event, dialogue, database, quest, battle, audio, and WYSIWYG breadth remain open. |
