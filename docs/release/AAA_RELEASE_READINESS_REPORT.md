...
**Verification base commit:** `4fb53f721b8b2a7d17f651a821a2b0ace1b7b596`
...
Required verification: run the `workflow_dispatch` release-candidate job on GitHub and record the remote run URL.

### RB-3: No Release Or Prerelease Tag Exists

**Status:** `PENDING`

No release tag should be created until RB-1 and RB-2 are resolved or formally waived by the release owner with owner, scope, issue URL, and expiration.
