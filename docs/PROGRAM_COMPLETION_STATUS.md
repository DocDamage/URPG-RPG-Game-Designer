...
2026-05-27 high-end MZ compatibility expansion checkpoint:
...
- New deterministic evidence surfaces cover legal full-project corpus descriptors, project-level compatibility scoring, event command coverage analytics, plugin repair estimates and migration suggestions, a visual-diff report contract, an opt-in runtime parity mode marked experimental, and a creator migration workbench snapshot.
- Runtime parity remains experimental until real RPG Maker MZ reference captures, backend parity evidence, and release-owner review exist. The current visual-diff lane is a report shell and contract, not a captured-reference parity claim.
