...
- Creator shell, virtual asset workflow, unified Map, and starter-project status: `docs/PROGRAM_COMPLETION_STATUS.md`, `docs/product/CREATOR_JOURNEY_BASELINE.md`, and `docs/superpowers/plans/2026-07-14-product-feature-usability-native-absorption-plan.md`
