...
- M8 has an initial Character Creator slice: Map opens the active project’s durable character draft without losing Map context, and that draft shares save, navigation, and recovery ownership. Event/dialogue/database/quest/battle/audio contextual authoring and the WYSIWYG done rule remain open. The Capybara repository is `reference_only`; any adopted concept needs URPG-native ownership, provenance/license evidence, deterministic tests, and no parallel browser/npm/cloud/save/pathfinding stack.
