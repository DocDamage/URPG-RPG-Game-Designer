...
- M7 now has checksummed, ignored snapshot primitives, orderly-session markers, five-minute bounded private capture of dirty Grid Parts, Perspective 2D, and ability drafts, plus an in-editor count and safe restore-to-new-folder action. It remains incomplete: guided recovery-project review/open flow, broader durable-surface coverage, explicit governed-asset relinking, and a creator walkthrough.
