...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--applied-csv", default="imports/reports/asset_safe_dedupe_applied.csv"
    )
    p.add_argument(
        "--summary-json", default="imports/reports/asset_safe_dedupe_summary.json"
    )
    p.add_argument(
        "--apply", action="store_true", help="Apply deletions. Default is plan-only."
    )
    p.add_argument(
        "--max-removals",
        type=int,
