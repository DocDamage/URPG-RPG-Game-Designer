...
$signoffDocPaths = @{
    ...
    "achievement_registry" = Join-Path $repoRoot "docs\ACHIEVEMENT_REGISTRY_CLOSURE_SIGNOFF.md"
    ...
    "export_validator" = Join-Path $repoRoot "docs\EXPORT_VALIDATOR_CLOSURE_SIGNOFF.md"
    "mod_registry" = Join-Path $repoRoot "docs\MOD_REGISTRY_CLOSURE_SIGNOFF.md"
    "analytics_dispatcher" = Join-Path $repoRoot "docs\ANALYTICS_DISPATCHER_CLOSURE_SIGNOFF.md"
}
