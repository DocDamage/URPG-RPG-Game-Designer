...
void bindLevelBuilder(EditorPanelRuntime& runtime, const std::filesystem::path& catalog_path) {
    ...
    const bool catalogLoaded =
        urpg::map::LoadGridPartCatalogFromProject(runtime.project_root, runtime.level_builder_catalog, catalog_path);
...
int main(int argc, char** argv) {
    try {
        ...
        bindLevelBuilder(panelRuntime, options.grid_part_catalog);
