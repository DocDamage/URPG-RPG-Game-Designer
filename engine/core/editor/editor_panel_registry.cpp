...
const std::vector<EditorPanelRegistryEntry> kRegistry = {
    ...
    {"quest", "Quest", "Narrative", EditorPanelExposure::Deferred, "editor/quest",
     "Deferred roadmap panel; narrative production workflow is outside the current release shell."},
    ...
    {"relationship", "Relationship", "Narrative", EditorPanelExposure::Deferred, "editor/relationship",
     "Deferred roadmap panel; relationship authoring is outside the current release shell."},
    ...
    {"timeline", "Timeline", "Presentation", EditorPanelExposure::Deferred, "editor/timeline",
     "Deferred until timeline authoring is selected for release shell registration."},
    ...
    {"balance", "Balance", "Gameplay", EditorPanelExposure::Deferred, "editor/balance",
     "Deferred until balance editing is selected for release shell registration."},
    ...
    {"crafting", "Crafting", "Gameplay", EditorPanelExposure::Deferred, "editor/crafting",
     "Deferred roadmap panel; crafting authoring is outside the current release shell."},
    ...
    {"npc", "NPC", "Worldbuilding", EditorPanelExposure::Deferred, "editor/npc",
     "Deferred roadmap panel; NPC authoring is outside the current release shell."},
