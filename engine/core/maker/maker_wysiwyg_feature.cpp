...
std::vector<std::string> makerWysiwygFeatureTypes() {
    return {"project_search_everywhere",
            ...
            "proximity_compass_objective_radar",
            "resource_manager_unused_asset_cleaner",
            "visual_inventory_builder",
            "animated_pictures_timeline",
            "horror_fx_builder",
            "cutscene_skip_fast_forward",
            "translation_helper_workspace",
            "deployment_cook_dashboard",
            "break_shield_system",
            "boost_point_system",
            "battle_weapon_swap",
            "order_turn_battle_system",
            "item_concoction_system",
            "unison_attack_builder",
            "timed_attack_qte_builder",
            "action_sequence_impact_builder",
            "side_battle_status_ui_builder",
            "victory_screen_builder",
            "state_tooltip_display",
            "animated_loading_screen_builder",
            "popup_builder",
            "animated_window_builder",
            "video_player_surface",
            "tactical_battle_system",
            "bullet_hell_maker",
            "duelist_card_battle_system",
            "spin_top_battle_system",
            "recruiting_board",
            "step_rewards_system",
            "event_spawner_solution",
            "smart_event_timers_progress",
            "actor_construct",
            "equip_construct_visible_equipment",
            "skill_equip_system",
            "front_view_battler_mode"};
}
