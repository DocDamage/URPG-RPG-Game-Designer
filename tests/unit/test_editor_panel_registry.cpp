...
const std::map<std::string, std::string>& CompiledPanelRegistryOwners() {
    static const std::map<std::string, std::string> owners = {
        ...
        {"editor/database/database_reference_workspace.cpp", "database"},
        ...
        {"editor/diagnostics/event_trace_diagnostics_panel.cpp", "event_trace"},
        ...
        {"editor/gameplay/gameplay_recipe_panel.cpp", "status_effect_designer"},
        ...
        {"editor/ui/menu_authoring_workspace.cpp", "menu_builder"},
